                ...
                <div class="loginform col-lg-5 border border-2 rounded-4 border-white bg-blur">
                    <form @submit.prevent="login" class="p-4">
                        <div class="form-group">
                            <h2 class="h2-medium text-white py-2">Forgot Password</h2>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" v-model="first_name" class="form-control-input"
                                placeholder="Enter first name" required />
                        </div>
                        <div class="form-group">
                            <input type="text" v-model="last_name" class="form-control-input"
                                placeholder="Enter last name" required />
                        </div>
                        <div class="form-group">
                            <input type="text" v-model="number" class="form-control-input"
