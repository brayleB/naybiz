    ...
    <div class="homesection container-fluid">
      <div class="row">
        ...
        <div class="col-lg-4 col-xl-4">
          <p class="p-medium text-black mt-5 pt-4">Back | HOA | <r class="p-medium text-primary" to="/register">Tenants
            </r>
          </p>
          ...
          <TabNav :tabs="['Request', 'Accepted']" :selected="selected" @selected="setSelected">
            <Tab :isSelected="selected === 'Request'">
              <div class="emptycon d-flex align-items-center justify-content-center"
                v-if="!tenants_requested || !tenants_requested.length">
                                ...
                                <div class="modal-body">
                                  <div class="container-fluid overflow-auto">
                                    <div class="card-body text-center mb-3">
                                      <img class="img-account-profile image-responsive mb-2 rounded-5"
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                              <div class="modal-content w-75 mx-auto" style="border-radius: .6rem;">
                                ...
                                <div class="modal-footer border-top-0">
                                  ...
                                  <div class="row w-100">
                                    <div class="col-xl-12">
                                      <button type="button" class="btn btn-danger w-100" style="border-radius: .6rem;"
