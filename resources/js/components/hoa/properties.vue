                                              ...
                                              <div class="modal-body">    
                                                ...
                                                <div class="card mb-4" style="margin-top: -2rem;">
                                                    <div class="row" style="margin-top: -2rem;">
                                                      <div class="col-md-6">
                                                          <div class="card-header"><label class="small mb-1 text-light-blue" for="first_name" >Tenant Name</label></div>
                                                          <div class="card-body">
                                                            <p class="card-text">Firstname Lastname</p>
                                                          </div>
                                                      </div>                        
                                                      <div class="col-md-6">
                                                          <div class="card-header"><label class="small mb-1 text-light-blue" for="first_name" >Tenant Contact Info</label></div>
                                                          <div class="card-body">
