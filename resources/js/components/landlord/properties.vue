                        ...
                        <div class="row py-4">                                 
                          <div class="col col-xl-6 mx-auto">                               
                            <!-- <label class="form-label" for="customFile">Default file input example</label>                          
                              ...
                              <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm upload-image-col">
                                  <input id="upload" type="file" @change="onFile" class="form-control border-0" required>
                                  <label id="upload-label" for="upload" class="font-weight-light text-muted upload-image-text">
                                    Max Size (8 mb), Type (jpg, jpeg, png, bmp, tiff)</label>
