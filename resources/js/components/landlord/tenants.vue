                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                      <div class="modal-content w-75 mx-auto" style="border-radius: .6rem;">
                                        ...
                                        <div class="modal-footer border-top-0">
                                          <div class="row w-100">
                                            <div class="col-xl-12">
                                              <button type="button" @click="clickAccept(); setTenant();" class="btn btn-primary w-100 my-1" style="border-radius: .6rem;" data-bs-dismiss="modal">Accept</button>                                        
                                            </div>
                                            <div class="col-xl-12">
                                              <button type="button" class="btn btn-danger w-100 my-1" @click="deleteTenant(tenant_view.id)" style="border-radius: .6rem;" data-bs-dismiss="modal">Trash</button>                                        
                                            </div>
                                          </div>
                                        </div>
                                      </div>
